// High-quality remodeling images for RemodelyAz
// These are carefully selected, high-resolution images that represent professional remodeling work
...
export const highQualityImages = [
  ...
  {
    id: "basement-renovation-1",
    name: "Finished Basement Entertainment Area",
    url: "https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=1200&h=800&fit=crop&crop=entropy&auto=format&q=90&sharp=15&sat=12",
    category: "Basement",
    description: "Complete basement renovation creating a comfortable entertainment space with custom bar, media area, and moisture-resistant materials.",
    tags: ["basement", "entertainment", "custom-bar", "media-room"]
  },

  // Outdoor Living
  {
    id: "outdoor-kitchen-1",
  ...
  // High-End Details
  {
    ...
    category: "Cabinetry",
    description: "Premium custom cabinetry installation with soft-close drawers, crown molding, and professional finish work.",
    tags: ["custom-cabinetry", "soft-close", "crown-molding", "professional-finish"]
  },
  {
    id: "tile-work-showcase-1",
    name: "Professional Tile Installation",
    url: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&h=800&fit=crop&crop=entropy&auto=format&q=90&sharp=15&sat=15",
    category: "Tile Work",
    description: "Expert tile installation showcasing intricate patterns, precise cuts, and flawless grout work in bathroom renovation.",
    tags: ["tile-installation", "intricate-patterns", "precise-cuts", "expert-work"]
  }
]
